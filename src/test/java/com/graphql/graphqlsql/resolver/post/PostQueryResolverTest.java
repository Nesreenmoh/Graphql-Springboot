...
import com.graphql.graphqlsql.resolver.author.FileReaderUtil;
...
class PostQueryResolverTest {
    ...
    public void shouldAbleToGetRecentPostData() throws IOException, JSONException {
        GraphQLResponse graphQLResponse = graphQLTestTemplate.
                postForResource("request/recent-posts-query.graphqls");
        assertThat(graphQLResponse.isOk(),equalTo(true));

        assertEquals(FileReaderUtil.read("response/recent-posts-query.json")
